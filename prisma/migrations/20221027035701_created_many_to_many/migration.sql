...
-- AddForeignKey
ALTER TABLE "Deliveries" ADD CONSTRAINT "Deliveries_id_client_fkey" FOREIGN KEY ("id_client") REFERENCES "clientdelivery"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
